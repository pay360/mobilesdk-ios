...
SF_RESOURCES_NAME="${SF_TARGET_NAME}Resources.bundle"
...
lipo -create "${BUILT_PRODUCTS_DIR}/${SF_EXECUTABLE_PATH}" "${SF_OTHER_BUILT_PRODUCTS_DIR}/${SF_EXECUTABLE_PATH}" -output "${BUILT_PRODUCTS_DIR}/${SF_WRAPPER_NAME}/${SF_TARGET_NAME}"
...
rm -rf  "build/${SF_TARGET_NAME}.framework"
